...
const appsModals = document.querySelectorAll(".apps-modal");
...
ScrollReveal().reveal('.home-img, .about-img, .apps-img', { delay: 100, origin: 'bottom' });
ScrollReveal().reveal('.apps .description, .contact-right', { delay: 150, origin: 'right' });
ScrollReveal().reveal('.about .description, .contact-right', { delay: 150, origin: 'right' });
ScrollReveal().reveal('.about .professional-list li', { delay: 100, origin: 'right', interval: 200 });
ScrollReveal().reveal('.skills-description, .services-description, .contact-card, .client-swiper, .contact-left h2', { delay: 200, origin: 'left' });
ScrollReveal().reveal('.experience-card, .service-card, .education, .portfolio .img-card', { delay: 250, origin: 'bottom', interval: 200 });
